...
agent.update_freq   = 1
agent.anneal_steps  = 1000
# update freq = 500
# no replay batch size = 128

## DIRECTORIES
weight_dir          = 'NN_weights/no_target_no_replay/'
fig_dir             = 'figures/no_target_no_replay/'
reward_file         = 'rewards_no_tar_no_rep.txt'
...
plotter.plot_learning_curve(gamma, reward_file, 
...
file_list     = ['rewards.txt', 'rewards_no_rep.txt', 'rewards_no_tar.txt',
                  'rewards_no_tar_no_rep.txt']
